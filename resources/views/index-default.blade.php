        ...
        <div class="wrap">
            <div class="fluid_container">
                <div class="camera_wrap camera_magenta_skin" id="camera_wrap_2">
                    <div data-thumb="../../public/images/them1.png" data-src="../../public/images/slider1.jpg">
                        <div class="camera_caption fadeFromBottom">
                            <h2>slider one</h2>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                    </div>
                    <div data-thumb="../../public/images/them2.jpg" data-src="../../public/images/slider2.jpg">
                        <div class="camera_caption fadeFromBottom">
                            <h2>slider two</h2>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                        </div>
                    </div>
                    <div data-thumb="../../public/images/them3.jpg" data-src="../../public/images/slider3.jpg">
                        <div class="camera_caption fadeFromBottom">
                            <h2>slider three</h2>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                    </div>
                    <div data-thumb="../../public/images/them4.jpg" data-src="../../public/images/slider4.jpg">
                        <div class="camera_caption fadeFromBottom">
                            <h2>slider four</h2>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                        </div>
                    ...
                    <div data-thumb="../../public/images/them6.jpg" data-src="../../public/images/slider6.jpg">
                        <div class="camera_caption fadeFromBottom">
                            <h2>slider six</h2>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
            ...
            <div class="top-grids">
                <div class="top-grid">
                    <div class="top-grid-info">
                        <img src="../../public/images/por.png" style="margin-top: 4px;" alt=" "/>
                ...
                <div class="top-grid">
                    <div class="top-grid-info">
                        <img src="../../public/images/wrok.png" alt=" "/>
                        <h2>check  out my  lastest portfolio items</h2>
                        <div class="clear"> </div>
                    </div>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p>
            ...
            <div class="main_btm">
                ...
                <div id="small-dialog1" class="mfp-hide">
                    <div class="pop_up">
                        ...
                        <img src="../../public/images/popup.jpg" alt=" "/>
                        ...
                        <div id="gallerylist">
                            ...
                            <div class="gallerylist-wrapper">
                                <a class="popup-with-zoom-anim" href="#small-dialog1">
                                    ...
                                    <span><img src="../../public/images/plus.png" alt=" "/> </span>
                                    <div class="desc">
                                        <h2>character desing</h2>
                                        <h3>june 15,2016</h3>
                                    </div>
                ...
                <script type="text/javascript" src="../../public/js/fliplightbox.min.js"></script>
